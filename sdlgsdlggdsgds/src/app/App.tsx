...
function HomePage({ currentUser, setCurrentUser, isDarkMode, setIsDarkMode }: { currentUser: any, setCurrentUser: any, isDarkMode: boolean, setIsDarkMode: any }) {
  ...
  // Get the 12 most recently added movies (by dateAdded timestamp)
          ...
          <div className="mb-4 md:hidden flex gap-2">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className={`h-9 pl-10 pr-10 rounded-lg text-sm ${isDarkMode ? 'bg-gray-800 text-white border-gray-700' : 'bg-white'}`}
              />
              {searchQuery && (
                <button
                  onClick={() => {
